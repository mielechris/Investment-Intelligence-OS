# T018 — Implement service identity model

**Epic:** E02 — Platform Configuration and Security  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-013  
**Dependencies:** T017  
...
Represent API, worker, scheduler, migration, backup, and agent identities.
...
- [ ] Service identity enum/model exists
- [ ] Audit events distinguish service actors
- [ ] No shared anonymous system actor for material writes
...
- [ ] Commit references `T018`.

## Suggested Commit

`feat(platform_security): implement service identity model [T018]`
