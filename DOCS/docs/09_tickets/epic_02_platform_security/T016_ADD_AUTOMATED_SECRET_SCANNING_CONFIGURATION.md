# T016 — Add automated secret scanning configuration
...
Detect committed keys, tokens, and high-risk credentials before release.
...
- [ ] Scanner configuration committed
- [ ] Test fixture is detected
- [ ] Known-safe placeholders do not fail scan
...
- [ ] Commit references `T016`.

## Suggested Commit

`feat(platform_security): add automated secret scanning configuration [T016]`
