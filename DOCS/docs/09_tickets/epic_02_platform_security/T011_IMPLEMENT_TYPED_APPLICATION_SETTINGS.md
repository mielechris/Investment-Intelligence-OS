# T011 — Implement typed application settings
...
Create typed environment-aware runtime configuration.
...
- [ ] Missing critical configuration fails startup
- [ ] Environment is enum validated
- [ ] Secret values are excluded from repr/logging
- [ ] Defaults are documented

## Required Tests

- Valid config test
- Missing critical key test
...
- [ ] Commit references `T011`.

## Suggested Commit

`feat(platform_security): implement typed application settings [T011]`
