# T014 — Implement common error taxonomy

**Epic:** E02 — Platform Configuration and Security  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-012,SPEC-013,SPEC-016  
**Dependencies:** T005  
...
Standardize retryable, permanent, quarantine, business rejection, and critical errors.
...
- [ ] Error base classes defined
- [ ] Retryability explicit
- [ ] Safe public error code available
- [ ] No secrets in error serialization
...
- [ ] Commit references `T014`.

## Suggested Commit

`feat(platform_security): implement common error taxonomy [T014]`
