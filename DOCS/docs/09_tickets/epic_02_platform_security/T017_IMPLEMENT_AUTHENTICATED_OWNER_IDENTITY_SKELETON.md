# T017 — Implement authenticated owner identity skeleton
...
Create a one-owner authentication boundary that can later evolve to roles.
...
- [ ] Authenticated owner identity available to API
- [ ] Anonymous privileged writes rejected
- [ ] Actor ID reaches audit context

## Required Tests

- Authenticated request test
- Anonymous command rejection
...
- [ ] Commit references `T017`.

## Suggested Commit

`feat(platform_security): implement authenticated owner identity skeleton [T017]`
