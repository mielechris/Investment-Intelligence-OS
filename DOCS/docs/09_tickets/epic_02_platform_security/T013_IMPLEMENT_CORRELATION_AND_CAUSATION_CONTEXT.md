# T013 — Implement correlation and causation context

**Epic:** E02 — Platform Configuration and Security  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-013,SPEC-016  
**Dependencies:** T005  
...
Provide stable correlation and causation IDs across API, jobs, logs, and events.
...
- [ ] New workflow receives correlation ID
- [ ] Child work receives causation ID
- [ ] Context propagates into logs
...
- [ ] Commit references `T013`.

## Suggested Commit

`feat(platform_security): implement correlation and causation context [T013]`
