# T020 — Implement security stand-down trigger interface
...
Allow integrity/security failures to activate a durable system stand-down state.
...
- [ ] Trigger writes durable stand-down state
- [ ] Reason and actor recorded
- [ ] New risk paths can query state
...
- [ ] Commit references `T020`.

## Suggested Commit

`feat(platform_security): implement security stand-down trigger interface [T020]`
