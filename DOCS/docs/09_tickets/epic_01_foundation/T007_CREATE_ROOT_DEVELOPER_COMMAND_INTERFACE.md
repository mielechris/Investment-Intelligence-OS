# T007 — Create root developer command interface
...
Provide simple repeatable commands for bootstrap, start, test, lint, migrate, and stop.
...
- [ ] Commit references `T007`.

## Suggested Commit

`feat(foundation): create root developer command interface [T007]`
