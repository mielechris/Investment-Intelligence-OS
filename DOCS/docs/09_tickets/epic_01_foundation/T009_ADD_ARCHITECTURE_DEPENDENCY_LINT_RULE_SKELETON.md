# T009 — Add architecture dependency-lint rule skeleton
...
Create an automated hook capable of detecting prohibited module dependency directions.
...
- [ ] Rule location documented
- [ ] At least one forbidden dependency fixture fails
- [ ] CI-ready command exists

## Required Tests

- Forbidden import fixture
- Allowed import fixture
...
- [ ] Commit references `T009`.

## Suggested Commit

`feat(foundation): add architecture dependency-lint rule skeleton [T009]`
