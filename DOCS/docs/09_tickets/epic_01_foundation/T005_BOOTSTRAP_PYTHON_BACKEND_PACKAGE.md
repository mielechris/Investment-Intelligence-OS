# T005 — Bootstrap Python backend package
...
Create the installable backend package and initial application entry points.
...
- [ ] Backend package installs locally
- [ ] API, worker, and scheduler entry points import successfully
- [ ] Python version constraint declared
- [ ] No provider SDK leaks into domain package
...
- [ ] Commit references `T005`.

## Suggested Commit

`feat(foundation): bootstrap python backend package [T005]`
