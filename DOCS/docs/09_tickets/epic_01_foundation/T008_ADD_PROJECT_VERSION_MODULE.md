# T008 — Add project version module
...
Expose IIOS application/release version from one canonical code location.
...
- [ ] API health can include version
- [ ] Version is not duplicated manually across code paths
...
- [ ] Commit references `T008`.

## Suggested Commit

`feat(foundation): add project version module [T008]`
