# T006 — Bootstrap frontend TypeScript application
...
Create the typed frontend shell used by the command center.
...
- [ ] TypeScript strict mode enabled or explicitly configured
- [ ] API client location established
- [ ] Paper-mode placeholder banner visible
...
- [ ] Commit references `T006`.

## Suggested Commit

`feat(foundation): bootstrap frontend typescript application [T006]`
