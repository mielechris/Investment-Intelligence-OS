...
Document required configuration names without containing real secrets.
...
- [ ] Includes environment, DB, object storage, model, source, and paper execution keys
- [ ] Explicitly documents no live broker credentials in V1

## Required Tests

- Secret scan on .env.example
...
- [ ] Commit references `T004`.

## Suggested Commit

`feat(foundation): add safe .env.example [T004]`
