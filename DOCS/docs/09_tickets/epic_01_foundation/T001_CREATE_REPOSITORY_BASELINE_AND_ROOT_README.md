# T001 — Create repository baseline and root README

**Epic:** E01 — Foundation and Repository  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-000,SPEC-015  
**Dependencies:** None  
...
Establish the canonical IIOS repository root, project identity, operating mode, and developer entry point.
...
- [ ] Root README describes IIOS mission and paper-only V1
- [ ] Existing top-level folders match architecture
- [ ] README links Packages 01–10
- [ ] No duplicate authoritative project charter remains

## Required Tests

- Documentation-link smoke test
...
- [ ] Commit references `T001`.

## Suggested Commit

`feat(foundation): create repository baseline and root readme [T001]`
