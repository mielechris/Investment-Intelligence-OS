# T003 — Add root .gitignore and artifact exclusions
...
Prevent secrets, build outputs, local databases, caches, and research artifacts from entering Git.
...
- [ ] Python, Node, environment files, IDE caches, databases, raw data, and generated artifacts excluded
- [ ] `.env.example` remains trackable
- [ ] No required source file is accidentally ignored

## Required Tests

- Git ignore verification
- Secret fixture remains untracked
...
- [ ] Commit references `T003`.

## Suggested Commit

`feat(foundation): add root .gitignore and artifact exclusions [T003]`
