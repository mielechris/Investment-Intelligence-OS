# T073 — Implement historical analog query service

**Epic:** E07 — Reasoning and Hypothesis  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-004,SPEC-021  
...
Retrieve comparable historical events using time-safe dimensions and expose similarities and differences.
...
- [ ] No future data in analog context
- [ ] Similarity dimensions recorded
...
- [ ] Commit references `T073`.

## Suggested Commit

`feat(reasoning): implement historical analog query service [T073]`
