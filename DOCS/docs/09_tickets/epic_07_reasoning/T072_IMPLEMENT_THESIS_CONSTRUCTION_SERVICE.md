# T072 — Implement thesis construction service

**Epic:** E07 — Reasoning and Hypothesis  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-017,SPEC-029  
**Dependencies:** T071  
...
Convert validated hypotheses into investable thesis versions with instrument, direction, horizon, catalysts, and invalidation.
...
- [ ] Instrument/disposition/horizon supported
- [ ] Invalidation required
- [ ] Source cutoff recorded
...
- [ ] Commit references `T072`.

## Suggested Commit

`feat(reasoning): implement thesis construction service [T072]`
