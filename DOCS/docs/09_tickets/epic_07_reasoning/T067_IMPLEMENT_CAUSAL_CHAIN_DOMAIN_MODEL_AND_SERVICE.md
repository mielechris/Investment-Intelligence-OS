# T067 — Implement causal-chain domain model and service
...
Persist ordered causal steps with mechanism, sign, lag, evidence, assumptions, confidence, and falsifiers.
...
- [ ] Sequence validated
- [ ] Mechanism required
- [ ] Evidence/assumption distinction explicit
- [ ] Versioned
...
- [ ] Commit references `T067`.

## Suggested Commit

`feat(reasoning): implement causal-chain domain model and service [T067]`
