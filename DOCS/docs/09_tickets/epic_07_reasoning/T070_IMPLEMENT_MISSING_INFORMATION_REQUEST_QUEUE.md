# T070 — Implement missing-information request queue
...
Create structured questions whose answers could materially alter confidence or promotion.
...
- [ ] Urgency and source domain stored
- [ ] Blocking flag supported
...
- [ ] Commit references `T070`.

## Suggested Commit

`feat(reasoning): implement missing-information request queue [T070]`
