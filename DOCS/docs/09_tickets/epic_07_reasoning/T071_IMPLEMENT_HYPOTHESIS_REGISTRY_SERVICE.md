# T071 — Implement hypothesis registry service

**Epic:** E07 — Reasoning and Hypothesis  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-017  
**Dependencies:** T029,T067,T068,T069  
...
Register, version, promote, revise, pause, reject, and retire falsifiable hypotheses.
...
- [ ] Falsifiable statement required
- [ ] Benchmark required
- [ ] Failure metric required
...
- [ ] Commit references `T071`.

## Suggested Commit

`feat(reasoning): implement hypothesis registry service [T071]`
