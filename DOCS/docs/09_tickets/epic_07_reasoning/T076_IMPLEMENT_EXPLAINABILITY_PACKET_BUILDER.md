# T076 — Implement explainability packet builder

**Epic:** E07 — Reasoning and Hypothesis  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-020  
**Dependencies:** T064,T067,T068,T071,T072  
...
Build a faithful persisted source-to-thesis explanation packet from stored lineage.
...
- [ ] Support and contradiction visible
- [ ] Counter-chain visible
- [ ] Versions/source cutoff included
...
- [ ] Commit references `T076`.

## Suggested Commit

`feat(reasoning): implement explainability packet builder [T076]`
