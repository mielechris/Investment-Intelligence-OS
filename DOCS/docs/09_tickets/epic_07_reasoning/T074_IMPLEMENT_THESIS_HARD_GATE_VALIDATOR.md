# T074 — Implement thesis hard-gate validator

**Epic:** E07 — Reasoning and Hypothesis  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-000,SPEC-029  
**Dependencies:** T072,T063,T068  
...
Block thesis promotion on missing evidence, counter-case, invalidation, critical freshness, or rights failures.
...
- [ ] Every hard gate individually testable
...
- [ ] Commit references `T074`.

## Suggested Commit

`feat(reasoning): implement thesis hard-gate validator [T074]`
