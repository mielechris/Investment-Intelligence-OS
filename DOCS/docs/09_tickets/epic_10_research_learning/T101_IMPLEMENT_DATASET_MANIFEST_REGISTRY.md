# T101 — Implement dataset-manifest registry
...
Create immutable research dataset manifests with source versions, cutoff rules, universe, features, labels, and hashes.
...
- [ ] Source rights included
- [ ] Cutoff rules mandatory
- [ ] Version immutable

## Required Tests

- Manifest create
- Missing cutoff rejection
...
- [ ] Commit references `T101`.

## Suggested Commit

`feat(research_learning): implement dataset-manifest registry [T101]`
