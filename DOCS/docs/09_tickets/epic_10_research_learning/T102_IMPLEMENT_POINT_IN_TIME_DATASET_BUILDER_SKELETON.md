# T102 — Implement point-in-time dataset builder skeleton
...
Build historical research datasets that filter all information by market availability.
...
- [ ] Decision cutoff parameter required
- [ ] Later evidence excluded
- [ ] Provider/source versions recorded

## Required Tests

- Future revision trap
- Later filing trap
...
- [ ] Commit references `T102`.

## Suggested Commit

`feat(research_learning): implement point-in-time dataset builder skeleton [T102]`
