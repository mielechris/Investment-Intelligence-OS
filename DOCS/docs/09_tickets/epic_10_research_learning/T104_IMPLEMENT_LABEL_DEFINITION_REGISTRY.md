# T104 — Implement label-definition registry
...
Version research outcome definitions and benchmark/horizon rules.
...
- [ ] Label horizon explicit
- [ ] Benchmark explicit
- [ ] Label separate from features

## Required Tests

- Label create
- Feature access to label rejection
...
- [ ] Commit references `T104`.

## Suggested Commit

`feat(research_learning): implement label-definition registry [T104]`
