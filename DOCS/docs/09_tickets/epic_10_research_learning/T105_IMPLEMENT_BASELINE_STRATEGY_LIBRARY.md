# T105 — Implement baseline strategy library
...
Provide cash, broad index, buy-and-hold, simple trend, and relevant simple baselines.
...
- [ ] Each research run can reference benchmark
- [ ] Baseline costs configurable
...
- [ ] Commit references `T105`.

## Suggested Commit

`feat(research_learning): implement baseline strategy library [T105]`
