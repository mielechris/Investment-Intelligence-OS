# T106 — Implement event-study engine V0.1
...
Measure abnormal returns around canonical event classes with benchmark and overlapping-event controls.
...
- [ ] Event timestamp/cutoff explicit
- [ ] Benchmark applied
- [ ] Sample size/distribution returned
- [ ] Duplicates handled

## Required Tests

- Policy event study fixture
...
- [ ] Commit references `T106`.

## Suggested Commit

`feat(research_learning): implement event-study engine v0.1 [T106]`
