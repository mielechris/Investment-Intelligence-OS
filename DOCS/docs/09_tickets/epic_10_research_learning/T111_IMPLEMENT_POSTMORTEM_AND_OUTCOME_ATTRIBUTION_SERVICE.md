# T111 — Implement postmortem and outcome attribution service

**Epic:** E10 — Research Backtesting and Learning  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-010,SPEC-030  
**Dependencies:** T032,T098,T072  
...
Compare expected causal path, actual path, risk, execution, and outcome while separating process quality from P&L.
...
- [ ] Expected vs actual steps recorded
- [ ] Luck/process distinction fields present
- [ ] Proposed updates do not auto-deploy
...
- [ ] Commit references `T111`.

## Suggested Commit

`feat(research_learning): implement postmortem and outcome attribution service [T111]`
