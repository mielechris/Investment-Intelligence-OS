# T032 — Create workflow research learning and audit tables

**Epic:** E03 — Database and Core Data Model  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-008,SPEC-010,SPEC-016  
...
Persist jobs, workflows, outbox/inbox, datasets, research runs, results, journal, postmortems, beliefs, audit events, incidents, and releases.
...
- [ ] Inbox unique key enforced
- [ ] Research run includes code/data versions
- [ ] Journal links source cutoff
- [ ] Audit actor/environment represented

## Required Tests

- Duplicate inbox test
- Research manifest persistence
- Audit insert
...
- [ ] Commit references `T032`.

## Suggested Commit

`feat(database): create workflow research learning and audit tables [T032]`
