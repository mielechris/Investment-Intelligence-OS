# T027 — Create ingestion and raw-record tables

**Epic:** E03 — Database and Core Data Model  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-018  
**Dependencies:** T026  
...
Persist retrieval attempts, raw metadata, parse results, normalization results, checkpoints, revisions, and quarantine cases.
...
- [ ] Raw content hash indexed
- [ ] Checkpoint is durable
- [ ] Revision link represented
- [ ] Quarantine case represented

## Required Tests

- Duplicate natural-key test
- Revision insert test
...
- [ ] Commit references `T027`.

## Suggested Commit

`feat(database): create ingestion and raw-record tables [T027]`
