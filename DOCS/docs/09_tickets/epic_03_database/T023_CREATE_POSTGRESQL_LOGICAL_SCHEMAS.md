# T023 — Create PostgreSQL logical schemas

**Epic:** E03 — Database and Core Data Model  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-002,SPEC-003,SPEC-007,SPEC-009,SPEC-016  
**Dependencies:** T022  
...
Create logical schemas for platform, source, ingest, market, knowledge, evidence, reasoning, agents, decision, portfolio, risk, execution, research, learning, workflow, and audit.
...
- [ ] All logical schemas exist
- [ ] Schema ownership documented
- [ ] Migration is reversible or forward-repair documented

## Required Tests

- Schema existence integration test
...
- [ ] Commit references `T023`.

## Suggested Commit

`feat(database): create postgresql logical schemas [T023]`
