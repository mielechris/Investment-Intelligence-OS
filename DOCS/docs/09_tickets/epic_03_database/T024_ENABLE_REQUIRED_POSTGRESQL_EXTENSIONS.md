# T024 — Enable required PostgreSQL extensions
...
Enable extensions required for UUID/text/vector capabilities approved by architecture.
...
- [ ] Commit references `T024`.

## Suggested Commit

`feat(database): enable required postgresql extensions [T024]`
