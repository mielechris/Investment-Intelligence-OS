# T026 — Create source registry tables
...
Persist Source, SourceEndpoint, SourceRightsPolicy, and freshness metadata.
...
- [ ] Foreign keys and constraints match Package 04
- [ ] Rights classification required
- [ ] Source criticality/freshness represented

## Required Tests

- Valid source insert
- Invalid rights class rejection
...
- [ ] Commit references `T026`.

## Suggested Commit

`feat(database): create source registry tables [T026]`
