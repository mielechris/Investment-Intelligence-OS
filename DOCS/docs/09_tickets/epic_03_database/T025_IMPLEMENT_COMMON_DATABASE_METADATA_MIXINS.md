# T025 — Implement common database metadata mixins

**Epic:** E03 — Database and Core Data Model  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-013  
...
Standardize UUID IDs, schema versions, timestamps, environment, and correlation metadata.
...
- [ ] UUID default defined
- [ ] Timezone-aware timestamps
- [ ] Environment stored where required
- [ ] No naive datetime defaults
...
- [ ] Commit references `T025`.

## Suggested Commit

`feat(database): implement common database metadata mixins [T025]`
