# T022 — Initialize migration framework
...
Create version-controlled database migration infrastructure.
...
- [ ] Current revision query works

## Required Tests

- Upgrade empty DB test
...
- [ ] Commit references `T022`.

## Suggested Commit

`feat(database): initialize migration framework [T022]`
