# T030 — Create agent committee and model registry tables

**Epic:** E03 — Database and Core Data Model  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-005,SPEC-006,SPEC-014  
...
Persist agents, models, prompts, runs, outputs, committee sessions, debate rounds, dissent, and decisions.
...
- [ ] Exact model/provider identifiers represented
- [ ] Prompt version represented
- [ ] Completed output immutable by application rule
- [ ] Dissent table present

## Required Tests

- Historical prompt lookup
- Dissent insert
...
- [ ] Commit references `T030`.

## Suggested Commit

`feat(database): create agent committee and model registry tables [T030]`
