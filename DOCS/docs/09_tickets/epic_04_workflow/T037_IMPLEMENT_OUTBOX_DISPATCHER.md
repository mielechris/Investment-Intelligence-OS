# T037 — Implement outbox dispatcher
...
Dispatch durable events to internal consumers with retry and telemetry.
...
- [ ] Dispatcher claims events safely
...
- [ ] Commit references `T037`.

## Suggested Commit

`feat(workflow): implement outbox dispatcher [T037]`
