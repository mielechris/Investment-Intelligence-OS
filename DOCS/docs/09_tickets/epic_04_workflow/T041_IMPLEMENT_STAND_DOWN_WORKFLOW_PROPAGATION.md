# T041 — Implement stand-down workflow propagation

**Epic:** E04 — Workflow and Orchestration  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-016,SPEC-007  
...
Stop creation of new risk/order workflows while preserving diagnostics and reconciliation.
...
- [ ] Stand-down cancels or blocks configured jobs
- [ ] Reconciliation allowed
- [ ] Audit maintained

## Required Tests

- Stand-down queue behavior
...
- [ ] Commit references `T041`.

## Suggested Commit

`feat(workflow): implement stand-down workflow propagation [T041]`
