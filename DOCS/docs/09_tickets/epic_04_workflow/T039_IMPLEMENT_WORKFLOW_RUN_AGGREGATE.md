# T039 — Implement workflow run aggregate
...
Group related jobs under one durable workflow with stage and status.
...
- [ ] Workflow has correlation ID
- [ ] Current stage visible
- [ ] Child jobs linked
- [ ] Workflow terminal state computed
...
- [ ] Commit references `T039`.

## Suggested Commit

`feat(workflow): implement workflow run aggregate [T039]`
