# T038 — Implement consumer inbox idempotency
...
Prevent duplicate event deliveries from causing duplicate durable effects.
...
- [ ] Consumer/event unique constraint used
- [ ] Duplicate event returns prior effect or no-op
...
- [ ] Commit references `T038`.

## Suggested Commit

`feat(workflow): implement consumer inbox idempotency [T038]`
