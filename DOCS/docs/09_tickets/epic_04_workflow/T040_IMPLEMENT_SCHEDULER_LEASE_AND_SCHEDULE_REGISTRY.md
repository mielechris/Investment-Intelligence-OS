# T040 — Implement scheduler lease and schedule registry
...
Create recurring workflow schedules without duplicate scheduler activity.
...
- [ ] Schedule key unique
- [ ] Leader/lease prevents duplicate scheduling
- [ ] Market calendar can be referenced

## Required Tests

- Two scheduler instance test
...
- [ ] Commit references `T040`.

## Suggested Commit

`feat(workflow): implement scheduler lease and schedule registry [T040]`
