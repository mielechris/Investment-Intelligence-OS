# T167 — Create deferred vendor decision scorecard

**Epic:** E16 — Institutional Readiness and Deferred Foundations  
**Priority:** P2  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-012,SPEC-015  
**Dependencies:** T165  
...
Define how future market-data, broker, model, object-storage, and cloud providers will be compared.
...
- [ ] Coverage, rights, cost, reliability, portability, security, and migration criteria included
- [ ] Does not choose vendor prematurely
...
- [ ] Commit references `T167`.

## Suggested Commit

`feat(institutional_readiness): create deferred vendor decision scorecard [T167]`
