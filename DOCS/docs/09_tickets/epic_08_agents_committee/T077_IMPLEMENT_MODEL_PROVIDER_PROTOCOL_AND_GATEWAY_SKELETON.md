# T077 — Implement model provider protocol and gateway skeleton

**Epic:** E08 — AI Agent Runtime and Committee  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-005,SPEC-014  
...
Centralize all model calls through one governed interface.
...
- [ ] Exact model ID required
- [ ] Timeout/retry normalized
- [ ] Usage/cost captured
...
- [ ] Commit references `T077`.

## Suggested Commit

`feat(agents_committee): implement model provider protocol and gateway skeleton [T077]`
