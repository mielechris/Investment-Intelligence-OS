# T078 — Implement model registry service

**Epic:** E08 — AI Agent Runtime and Committee  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-014  
**Dependencies:** T030,T077  
...
Register approved models, capabilities, restrictions, status, cost metadata, and active dates.
...
- [ ] Unapproved model rejected
- [ ] Retired model remains queryable
- [ ] Restrictions stored
...
- [ ] Commit references `T078`.

## Suggested Commit

`feat(agents_committee): implement model registry service [T078]`
