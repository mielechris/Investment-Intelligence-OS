# T080 — Implement governed retrieval builder
...
Build agent context with rights, cutoff, entity, source, deduplication, and size filters.
...
- [ ] Commit references `T080`.

## Suggested Commit

`feat(agents_committee): implement governed retrieval builder [T080]`
