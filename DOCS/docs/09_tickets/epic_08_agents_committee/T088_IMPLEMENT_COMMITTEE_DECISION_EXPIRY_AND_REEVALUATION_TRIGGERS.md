# T088 — Implement committee decision expiry and reevaluation triggers
...
Expire stale committee decisions and request a new session after material world/evidence changes.
...
- [ ] Expiry enforced
- [ ] Material update can supersede session
- [ ] Old decision remains historical

## Required Tests

- Expired decision
- Evidence retraction reevaluation
...
- [ ] Commit references `T088`.

## Suggested Commit

`feat(agents_committee): implement committee decision expiry and reevaluation triggers [T088]`
