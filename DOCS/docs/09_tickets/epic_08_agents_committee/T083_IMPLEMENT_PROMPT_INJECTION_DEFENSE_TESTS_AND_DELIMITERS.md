# T083 — Implement prompt-injection defense tests and delimiters

**Epic:** E08 — AI Agent Runtime and Committee  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-005,SPEC-013  
**Dependencies:** T080,T082  
...
Treat external source text as data and prevent it from changing authority or tool policy.
...
- [ ] Retrieved text clearly delimited
- [ ] Tool authority cannot be altered by content
- [ ] Known injection fixture fails safely

## Required Tests

- Injection fixture
- Secret-request fixture
...
- [ ] Commit references `T083`.

## Suggested Commit

`feat(agents_committee): implement prompt-injection defense tests and delimiters [T083]`
