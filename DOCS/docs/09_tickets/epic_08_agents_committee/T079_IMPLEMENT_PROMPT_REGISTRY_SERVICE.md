# T079 — Implement prompt registry service
...
Version prompts, output schemas, retrieval policies, tool policies, and approval state.
...
- [ ] Commit references `T079`.

## Suggested Commit

`feat(agents_committee): implement prompt registry service [T079]`
