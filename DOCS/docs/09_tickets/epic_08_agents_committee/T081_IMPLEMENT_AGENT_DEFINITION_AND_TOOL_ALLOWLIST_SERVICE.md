# T081 — Implement agent definition and tool-allowlist service
...
Load Agent Cards into enforceable runtime definitions and tool policies.
...
- [ ] Agent mandate/version stored
- [ ] Allowed tools explicit
- [ ] Default-deny tools
- [ ] Runtime budgets available
...
- [ ] Commit references `T081`.

## Suggested Commit

`feat(agents_committee): implement agent definition and tool-allowlist service [T081]`
