# T086 — Implement Skeptic / Red Team V0.1
...
Operationalize adversarial review for false causality, priced-in expectations, leakage, crowding, and alternative explanations.
...
- [ ] Must produce strongest credible objection or justified abstention
- [ ] Uses evidence
- [ ] Cannot suppress thesis history
...
- [ ] Commit references `T086`.

## Suggested Commit

`feat(agents_committee): implement skeptic / red team v0.1 [T086]`
