# T085 — Implement Macro and Rates Analyst V0.1
...
Operationalize the Macro Analyst card with point-in-time rates, macro, liquidity, and regime context.
...
- [ ] Revision leakage absent
- [ ] Contradictory indicators supported

## Required Tests

- Macro revision scenario
- Rate shock scenario
...
- [ ] Commit references `T085`.

## Suggested Commit

`feat(agents_committee): implement macro and rates analyst v0.1 [T085]`
