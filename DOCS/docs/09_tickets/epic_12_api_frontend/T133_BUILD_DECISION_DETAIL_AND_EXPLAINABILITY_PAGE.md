# T133 — Build decision detail and explainability page

**Epic:** E12 — API and Frontend Command Center  
**Priority:** P0/P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-011,SPEC-020  
**Dependencies:** T076,T131,T129  
...
Allow the operator to trace a decision from thesis through claims, evidence, agents, dissent, risk, order, outcome, and postmortem.

## Why This Matters

Makes governed system state usable without moving authority into the browser.
...
- [ ] Links resolve backward to source/evidence
- [ ] Historical versions displayed
- [ ] Contradiction/dissent visible

## Required Tests

- Golden decision render
...
- [ ] Commit references `T133`.

## Suggested Commit

`feat(api_frontend): build decision detail and explainability page [T133]`
