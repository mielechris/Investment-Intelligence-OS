# T129 — Implement hypothesis thesis and committee endpoints
...
**Dependencies:** T071,T072,T087,T125  
...
Expose create/query commands for hypotheses, theses, committee sessions, and decisions.
...
- [ ] State-changing commands idempotent
- [ ] Long committee work returns job ID
...
- [ ] Commit references `T129`.

## Suggested Commit

`feat(api_frontend): implement hypothesis thesis and committee endpoints [T129]`
