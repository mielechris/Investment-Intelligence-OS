# T127 — Implement canonical API error responses
...
Map domain/platform errors into stable safe API error codes with correlation IDs.
...
- [ ] Commit references `T127`.

## Suggested Commit

`feat(api_frontend): implement canonical api error responses [T127]`
