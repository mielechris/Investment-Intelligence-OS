# T131 — Generate typed frontend API client

**Epic:** E12 — API and Frontend Command Center  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-011,SPEC-012  
**Dependencies:** T125,T126,T127,T128,T129,T130  
...
- [ ] Frontend compile uses typed client
- [ ] No duplicate manual API type definitions for generated contracts
...
- [ ] Commit references `T131`.

## Suggested Commit

`feat(api_frontend): generate typed frontend api client [T131]`
