# T134 — Build portfolio risk research and system-health pages

**Epic:** E12 — API and Frontend Command Center  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-011  
**Dependencies:** T131,T130,T111  
...
Provide inspectable views for exposures, drawdown, paper positions, research results, source/model/job health, and incidents.
...
- [ ] Causal-cluster exposure shown
- [ ] Research runs searchable
...
- [ ] Commit references `T134`.

## Suggested Commit

`feat(api_frontend): build portfolio risk research and system-health pages [T134]`
