# T132 — Build Today command-center page
...
**Dependencies:** T006,T131,T128,T130  
...
Display paper mode, health, world state, event radar, opportunity board, portfolio, risk, and learning summary.
...
- [ ] Commit references `T132`.

## Suggested Commit

`feat(api_frontend): build today command-center page [T132]`
