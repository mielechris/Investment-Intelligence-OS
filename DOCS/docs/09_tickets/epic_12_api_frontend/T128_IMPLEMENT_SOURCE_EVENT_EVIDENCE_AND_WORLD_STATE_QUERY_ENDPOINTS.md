# T128 — Implement source event evidence and world-state query endpoints
...
**Dependencies:** T043,T061,T064,T062,T125  
...
Expose governed read APIs for source health, events, entities, evidence, and world state.
...
- [ ] Cutoff/freshness metadata returned
- [ ] Evidence lineage links available
...
- [ ] Commit references `T128`.

## Suggested Commit

`feat(api_frontend): implement source event evidence and world-state query endpoints [T128]`
