# T126 — Implement API authentication and authorization middleware
...
Require owner identity for privileged API commands.
...
- [ ] Anonymous privileged calls rejected
- [ ] Actor propagated
- [ ] Read-only/privileged distinctions available
...
- [ ] Commit references `T126`.

## Suggested Commit

`feat(api_frontend): implement api authentication and authorization middleware [T126]`
