# T130 — Implement portfolio risk order and journal endpoints
...
**Dependencies:** T090,T094,T095,T099,T111,T125  
...
Expose paper portfolio, risk, paper order, reconciliation, and journal queries/actions.
...
- [ ] No API bypass of risk
- [ ] Portfolio values backend-derived
- [ ] Kill-switch state visible

## Required Tests

- Risk request
- Order intent rejection
...
- [ ] Commit references `T130`.

## Suggested Commit

`feat(api_frontend): implement portfolio risk order and journal endpoints [T130]`
