# T095 — Implement paper order-intent service
...
Create an idempotent paper order intent only from active thesis, committee, and risk decisions.
...
- [ ] Required lineage validated
- [ ] PAPER environment enforced
...
- [ ] Commit references `T095`.

## Suggested Commit

`feat(portfolio_risk_execution): implement paper order-intent service [T095]`
