# T089 — Create initial paper portfolio and account service
...
Create a paper-only portfolio/account with starting cash and base currency.
...
- [ ] Environment PAPER
- [ ] Starting cash recorded
- [ ] Cash ledger authoritative
- [ ] Audit event
...
- [ ] Commit references `T089`.

## Suggested Commit

`feat(portfolio_risk_execution): create initial paper portfolio and account service [T089]`
