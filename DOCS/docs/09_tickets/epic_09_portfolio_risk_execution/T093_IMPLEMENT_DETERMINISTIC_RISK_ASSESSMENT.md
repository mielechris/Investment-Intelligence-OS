# T093 — Implement deterministic risk assessment

**Epic:** E09 — Portfolio Risk and Paper Execution  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-007  
**Dependencies:** T092,T090,T091,T074  
...
Evaluate position, theme, sector, gross/net, liquidity, volatility, correlation, drawdown, freshness, and accounting state.
...
- [ ] Rules deterministic
- [ ] Triggered rule IDs recorded
- [ ] Portfolio effect computed
- [ ] No model output can bypass
...
- [ ] Commit references `T093`.

## Suggested Commit

`feat(portfolio_risk_execution): implement deterministic risk assessment [T093]`
