# T091 — Implement causal-cluster exposure mapper
...
Map positions and candidate theses to shared policy, macro, commodity, geopolitical, and theme drivers.
...
- [ ] Weights/confidence stored
- [ ] Cluster exposure appears in snapshot

## Required Tests

- Three tickers one policy theme
...
- [ ] Commit references `T091`.

## Suggested Commit

`feat(portfolio_risk_execution): implement causal-cluster exposure mapper [T091]`
