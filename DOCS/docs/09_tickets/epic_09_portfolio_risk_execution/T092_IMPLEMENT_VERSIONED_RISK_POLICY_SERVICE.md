# T092 — Implement versioned risk-policy service
...
Load and version initial paper risk limits and stand-down rules.
...
- [ ] No hard-coded only policy
- [ ] Effective dates/version
- [ ] Changes audited
- [ ] Paper defaults match governance unless explicitly changed
...
- [ ] Commit references `T092`.

## Suggested Commit

`feat(portfolio_risk_execution): implement versioned risk-policy service [T092]`
