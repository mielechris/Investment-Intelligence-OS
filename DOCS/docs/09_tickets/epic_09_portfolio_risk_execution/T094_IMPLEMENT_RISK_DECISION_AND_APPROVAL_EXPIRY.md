# T094 — Implement risk decision and approval expiry
...
Produce APPROVED, APPROVED_REDUCED, VETOED, WATCH, or EXPIRED outcomes with max size and reasons.
...
- [ ] Approval has expiry
- [ ] Veto prevents order intent
- [ ] Reduced approval max size enforced
...
- [ ] Commit references `T094`.

## Suggested Commit

`feat(portfolio_risk_execution): implement risk decision and approval expiry [T094]`
