# T099 — Implement portfolio reconciliation service
...
Reconcile intents, orders, fills, cash, positions, and snapshots.
...
- [ ] Mismatch details recorded
- [ ] Critical mismatch activates no-new-risk/stand-down policy
- [ ] Daily run supported
...
- [ ] Commit references `T099`.

## Suggested Commit

`feat(portfolio_risk_execution): implement portfolio reconciliation service [T099]`
