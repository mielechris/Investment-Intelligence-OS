# T098 — Implement atomic paper accounting ledger
...
Apply fills atomically to cash, lots, positions, fees, realized/unrealized state, and audit.
...
- [ ] Duplicate fill blocked
- [ ] Cash/position update atomic
- [ ] Lot references preserved
- [ ] Rollback on failure
...
- [ ] Commit references `T098`.

## Suggested Commit

`feat(portfolio_risk_execution): implement atomic paper accounting ledger [T098]`
