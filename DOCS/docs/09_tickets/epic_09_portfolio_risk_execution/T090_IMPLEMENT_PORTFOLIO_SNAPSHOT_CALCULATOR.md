# T090 — Implement portfolio snapshot calculator
...
Calculate NAV, cash, gross/net exposure, P&L, and exposure breakdowns from authoritative ledger/positions.
...
- [ ] Price cutoff recorded
- [ ] Snapshot reproducible
- [ ] No browser-only calculation
...
- [ ] Commit references `T090`.

## Suggested Commit

`feat(portfolio_risk_execution): implement portfolio snapshot calculator [T090]`
