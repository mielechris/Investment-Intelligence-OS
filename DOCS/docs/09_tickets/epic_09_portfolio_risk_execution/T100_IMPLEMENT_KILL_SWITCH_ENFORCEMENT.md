# T100 — Implement kill-switch enforcement
...
Block new order activity when kill switch is active and preserve diagnostic/reconciliation paths.
...
- [ ] Open paper orders handled per policy
...
- [ ] Commit references `T100`.

## Suggested Commit

`feat(portfolio_risk_execution): implement kill-switch enforcement [T100]`
