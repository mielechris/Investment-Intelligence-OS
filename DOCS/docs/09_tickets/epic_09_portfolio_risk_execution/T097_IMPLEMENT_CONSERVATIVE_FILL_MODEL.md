# T097 — Implement conservative fill model
...
Simulate fills with bid/ask or bar-based spread, slippage, fees, latency, and partial fills.
...
- [ ] Fill model version recorded
- [ ] Costs explicit
- [ ] Partial fill supported
- [ ] No idealized hindsight fill
...
- [ ] Commit references `T097`.

## Suggested Commit

`feat(portfolio_risk_execution): implement conservative fill model [T097]`
