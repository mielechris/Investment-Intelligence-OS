# T061 — Implement policy lifecycle state projector
...
Project policy events into explicit stages without conflating rhetoric and implementation.
...
- [ ] Remark remains distinct from formal action
- [ ] Stage changes evidence-linked
- [ ] Legal/effective dates separate
- [ ] Historical state queryable

## Required Tests

- Remark fixture
- Formal action fixture
- Challenge/reversal fixture
...
- [ ] Commit references `T061`.

## Suggested Commit

`feat(knowledge_evidence): implement policy lifecycle state projector [T061]`
