# T065 — Implement evidence deduplication and independence clustering

**Epic:** E06 — World Model and Evidence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-003,SPEC-018  
**Dependencies:** T063,T050  
...
Detect repeated/syndicated evidence and estimate independence.
...
- [ ] Common original source cluster represented
- [ ] Duplicate articles do not multiply corroboration
- [ ] Cluster visible to agents

## Required Tests

- Syndicated story fixture
...
- [ ] Commit references `T065`.

## Suggested Commit

`feat(knowledge_evidence): implement evidence deduplication and independence clustering [T065]`
