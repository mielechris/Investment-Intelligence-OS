# T060 — Implement entity relationship service

**Epic:** E06 — World Model and Evidence  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-002,SPEC-027  
...
Persist evidence-backed, time-valid relationships such as supplies, regulates, owns, depends_on, and exposed_to.
...
- [ ] Evidence required for material relationship
- [ ] Validity intervals supported
- [ ] Inference labeled
...
- [ ] Commit references `T060`.

## Suggested Commit

`feat(knowledge_evidence): implement entity relationship service [T060]`
