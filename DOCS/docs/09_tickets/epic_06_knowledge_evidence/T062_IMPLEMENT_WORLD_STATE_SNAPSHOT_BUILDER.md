# T062 — Implement world-state snapshot builder

**Epic:** E06 — World Model and Evidence  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-002,SPEC-021  
**Dependencies:** T057,T060,T050  
...
Create immutable as-known-at snapshots across active events, entities, policy state, regimes, stale domains, and health.
...
- [ ] Snapshot has cutoff and source-version hash
- [ ] Immutable
- [ ] Stale domains included
- [ ] Historical cutoff excludes later data
...
- [ ] Commit references `T062`.

## Suggested Commit

`feat(knowledge_evidence): implement world-state snapshot builder [T062]`
