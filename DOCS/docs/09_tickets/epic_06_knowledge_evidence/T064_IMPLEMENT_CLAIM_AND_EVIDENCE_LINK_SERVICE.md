# T064 — Implement claim and evidence-link service
...
Persist FACT, INFERENCE, and HYPOTHESIS claims with support/contradiction links.
...
- [ ] Claim type required
- [ ] Material claim needs support before promotion
- [ ] Contradiction can coexist
- [ ] Link explanation stored
...
- [ ] Commit references `T064`.

## Suggested Commit

`feat(knowledge_evidence): implement claim and evidence-link service [T064]`
