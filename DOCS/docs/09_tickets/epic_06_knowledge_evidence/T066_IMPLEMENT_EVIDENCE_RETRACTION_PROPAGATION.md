# T066 — Implement evidence retraction propagation
...
Find dependent claims, chains, theses, and open positions when evidence is retracted or invalidated.
...
- [ ] Affected objects query returns dependencies
- [ ] Reevaluation workflow emitted
- [ ] Historical decision preserved

## Required Tests

- Retraction dependency test
...
- [ ] Commit references `T066`.

## Suggested Commit

`feat(knowledge_evidence): implement evidence retraction propagation [T066]`
