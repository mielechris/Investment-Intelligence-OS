# T057 — Implement entity registry repository and service
...
Create canonical entities, aliases, identifiers, and lookup operations.
...
- [ ] Canonical ID stable
- [ ] External identifiers time-aware
- [ ] Alias queries work
- [ ] Writes audited
...
- [ ] Commit references `T057`.

## Suggested Commit

`feat(knowledge_evidence): implement entity registry repository and service [T057]`
