# T046 — Implement raw-record capture service
...
Persist raw metadata only after durable object capture, then emit RawRecordStored.
...
- [ ] Object stored before downstream parse
- [ ] Content hash recorded
- [ ] Retrieval metadata persisted
- [ ] Outbox event created atomically

## Required Tests

- Raw capture integration test
- Object failure test
...
- [ ] Commit references `T046`.

## Suggested Commit

`feat(ingestion): implement raw-record capture service [T046]`
