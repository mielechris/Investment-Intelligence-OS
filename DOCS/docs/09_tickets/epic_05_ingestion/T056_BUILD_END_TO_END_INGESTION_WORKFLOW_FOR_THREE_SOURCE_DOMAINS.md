# T056 — Build end-to-end ingestion workflow for three source domains
...
**Dependencies:** T052,T053,T054,T055,T042  
...
Run policy, macro, non-policy, and required market-data ingestion through durable jobs into canonical storage.
...
- [ ] One workflow ingests all three domains
- [ ] Failures visible per source
- [ ] Raw-to-canonical lineage complete
- [ ] Workflow correlation ID spans pipeline

## Required Tests

- Vertical ingestion integration test
...
- [ ] Commit references `T056`.

## Suggested Commit

`feat(ingestion): build end-to-end ingestion workflow for three source domains [T056]`
