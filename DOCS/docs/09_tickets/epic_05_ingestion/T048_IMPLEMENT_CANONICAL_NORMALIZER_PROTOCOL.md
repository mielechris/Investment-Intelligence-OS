# T048 — Implement canonical normalizer protocol
...
Convert parser outputs into canonical events/data objects with warnings and validation.
...
- [ ] Timestamp warnings preserved

## Required Tests

- Valid normalize fixture
...
- [ ] Commit references `T048`.

## Suggested Commit

`feat(ingestion): implement canonical normalizer protocol [T048]`
