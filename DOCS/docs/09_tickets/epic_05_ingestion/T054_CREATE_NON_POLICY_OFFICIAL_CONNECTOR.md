# T054 — Create non-policy official connector
...
Ingest one non-policy primary source such as SEC, NOAA, USDA, EIA, CFTC, Treasury, or trade agency.
...
- [ ] Commit references `T054`.

## Suggested Commit

`feat(ingestion): create non-policy official connector [T054]`
