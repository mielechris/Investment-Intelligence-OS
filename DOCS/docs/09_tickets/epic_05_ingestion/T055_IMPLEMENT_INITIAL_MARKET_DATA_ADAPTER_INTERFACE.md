# T055 — Implement initial market-data adapter interface
...
Provide instrument/price lookup through a vendor-neutral adapter sufficient for the vertical slice.
...
- [ ] Historical bar query supported
- [ ] Current/delayed quote capability declared
- [ ] Market calendar/reference available or explicitly separated
...
- [ ] Commit references `T055`.

## Suggested Commit

`feat(ingestion): implement initial market-data adapter interface [T055]`
