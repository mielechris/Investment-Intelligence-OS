# T050 — Implement source freshness and health calculator

**Epic:** E05 — Source Registry and Ingestion  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-018  
**Dependencies:** T043,T049  
...
Calculate reachability, freshness, parse success, schema stability, and operational health.
...
- [ ] Source-specific freshness thresholds used
- [ ] Criticality impacts system health
- [ ] Health history persisted

## Required Tests

- Fresh source
- Stale source
- Critical stale source
...
- [ ] Commit references `T050`.

## Suggested Commit

`feat(ingestion): implement source freshness and health calculator [T050]`
