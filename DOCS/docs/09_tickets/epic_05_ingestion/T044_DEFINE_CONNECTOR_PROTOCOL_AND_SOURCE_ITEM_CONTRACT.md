# T044 — Define connector protocol and source item contract
...
Create provider-neutral connector interfaces for discovery, fetch, checkpoint, and health.
...
- [ ] No provider SDK types in domain protocol
- [ ] SourceItem includes external identity/time metadata
- [ ] Capability documented

## Required Tests

- Fake connector contract test
...
- [ ] Commit references `T044`.

## Suggested Commit

`feat(ingestion): define connector protocol and source item contract [T044]`
