# T049 — Implement source deduplication and revision detection
...
Detect duplicate payloads and changed revisions without overwriting history.
...
- [ ] Identical content produces no duplicate canonical effect
- [ ] Changed content creates revision link
- [ ] Revision emits reevaluation event where material
...
- [ ] Commit references `T049`.

## Suggested Commit

`feat(ingestion): implement source deduplication and revision detection [T049]`
