# T045 — Implement immutable object-storage adapter

**Epic:** E05 — Source Registry and Ingestion  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-015  
...
Store and retrieve immutable source payloads through the approved object-storage interface.
...
- [ ] Put/get/head supported
- [ ] Content hash verified
- [ ] Overwrite of immutable key blocked or versioned

## Required Tests

- Round-trip object test
...
- [ ] Commit references `T045`.

## Suggested Commit

`feat(ingestion): implement immutable object-storage adapter [T045]`
