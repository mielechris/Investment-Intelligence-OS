# T053 — Create Federal Reserve/macro connector

**Epic:** E05 — Source Registry and Ingestion  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-021  
...
Ingest one approved Federal Reserve or primary macro source.
...
- [ ] Release time/market availability represented
- [ ] Revision policy documented
- [ ] Fixture normalizes

## Required Tests

- Known release fixture
- Revision fixture
...
- [ ] Commit references `T053`.

## Suggested Commit

`feat(ingestion): create federal reserve/macro connector [T053]`
