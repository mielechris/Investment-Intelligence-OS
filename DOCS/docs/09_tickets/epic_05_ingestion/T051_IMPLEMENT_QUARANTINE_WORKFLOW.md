# T051 — Implement quarantine workflow

**Epic:** E05 — Source Registry and Ingestion  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-001,SPEC-013,SPEC-018  
**Dependencies:** T019,T027,T050  
...
Quarantine uncertain, malformed, prohibited, or rights-ambiguous source records.
...
- [ ] Quarantined records excluded from reasoning retrieval
- [ ] Reason recorded
- [ ] Resolution path exists

## Required Tests

- Rights uncertainty quarantine
- Malformed timestamp quarantine
...
- [ ] Commit references `T051`.

## Suggested Commit

`feat(ingestion): implement quarantine workflow [T051]`
