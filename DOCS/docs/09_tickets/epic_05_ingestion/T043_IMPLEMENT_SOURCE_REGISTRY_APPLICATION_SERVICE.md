# T043 — Implement source registry application service
...
Create approved source registration, enable/disable, rights, criticality, and freshness workflows.
...
- [ ] Source creation validated
- [ ] Rights required
- [ ] Disable does not erase history
- [ ] Changes audited
...
- [ ] Commit references `T043`.

## Suggested Commit

`feat(ingestion): implement source registry application service [T043]`
