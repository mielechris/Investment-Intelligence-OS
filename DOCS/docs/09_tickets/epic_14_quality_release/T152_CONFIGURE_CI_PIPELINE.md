...
**Dependencies:** T145,T146,T147,T148,T149,T150,T151  
...
Run formatting, lint, type, unit, integration, security, migration, and golden-trace gates.
...
- [ ] CI workflow defined
- [ ] Required jobs fail on defects
- [ ] Artifacts retained as appropriate
...
- [ ] Commit references `T152`.

## Suggested Commit

`feat(quality_release): configure ci pipeline [T152]`
