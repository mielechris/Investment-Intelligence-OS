# T151 — Implement failure-path golden scenarios
...
Test stale source, prompt injection, risk veto, duplicate event, worker crash, and accounting mismatch end-to-end.
...
- [ ] Each scenario reaches safe terminal state
- [ ] No hidden partial order
- [ ] Incident/audit where expected
...
- [ ] Commit references `T151`.

## Suggested Commit

`feat(quality_release): implement failure-path golden scenarios [T151]`
