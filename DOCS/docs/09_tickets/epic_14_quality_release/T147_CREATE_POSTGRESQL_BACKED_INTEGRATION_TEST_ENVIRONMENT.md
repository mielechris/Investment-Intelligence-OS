# T147 — Create PostgreSQL-backed integration test environment
...
Run integration tests against real PostgreSQL behavior rather than relying solely on lightweight substitutes.
...
- [ ] Commit references `T147`.

## Suggested Commit

`feat(quality_release): create postgresql-backed integration test environment [T147]`
