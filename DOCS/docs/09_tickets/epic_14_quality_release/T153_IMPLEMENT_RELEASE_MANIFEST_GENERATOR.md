# T153 — Implement release manifest generator
...
Create release manifest containing code, migrations, dependencies, model/prompt versions, environment, tests, and known limitations.
...
- [ ] Commit references `T153`.

## Suggested Commit

`feat(quality_release): implement release manifest generator [T153]`
