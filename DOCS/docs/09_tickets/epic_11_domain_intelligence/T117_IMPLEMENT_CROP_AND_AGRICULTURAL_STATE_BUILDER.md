# T117 — Implement crop and agricultural state builder

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-024,SPEC-026  
**Dependencies:** T116,T028  
...
Combine crop calendar, condition, weather, inventory, yield, and trade state.
...
- [ ] Crop stage represented
- [ ] Geography represented
- [ ] Weather alone does not produce thesis
- [ ] Historical state supported
...
- [ ] Commit references `T117`.

## Suggested Commit

`feat(domain_intelligence): implement crop and agricultural state builder [T117]`
