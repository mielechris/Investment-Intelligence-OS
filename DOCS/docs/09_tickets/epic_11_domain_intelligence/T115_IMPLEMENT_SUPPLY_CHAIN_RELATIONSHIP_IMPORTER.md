# T115 — Implement supply-chain relationship importer

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-023  
**Dependencies:** T060  
...
Load evidence-backed supplier/customer/facility/route relationships into the knowledge graph.
...
- [ ] Validity interval required
- [ ] Evidence required
- [ ] Alternative suppliers supported
...
- [ ] Commit references `T115`.

## Suggested Commit

`feat(domain_intelligence): implement supply-chain relationship importer [T115]`
