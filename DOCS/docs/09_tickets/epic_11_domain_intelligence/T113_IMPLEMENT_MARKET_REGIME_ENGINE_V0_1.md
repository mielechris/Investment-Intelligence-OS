# T113 — Implement market regime engine V0.1

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-021  
**Dependencies:** T062,T102  
...
Calculate point-in-time regime dimensions for growth, inflation, liquidity, policy stance, credit, volatility, dollar, and risk appetite.
...
- [ ] Probabilities rather than forced certainty
- [ ] Supporting/contradictory indicators stored
- [ ] Historical cutoff enforced
...
- [ ] Commit references `T113`.

## Suggested Commit

`feat(domain_intelligence): implement market regime engine v0.1 [T113]`
