# T119 — Implement commodity state and futures-curve builder

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-026  
**Dependencies:** T055,T117,T118  
...
Represent production, consumption, inventory, import/export, seasonality, spot/curve, and positioning.
...
- [ ] Spot and futures distinct
- [ ] Contract identity respected
- [ ] Inventory timestamped
...
- [ ] Commit references `T119`.

## Suggested Commit

`feat(domain_intelligence): implement commodity state and futures-curve builder [T119]`
