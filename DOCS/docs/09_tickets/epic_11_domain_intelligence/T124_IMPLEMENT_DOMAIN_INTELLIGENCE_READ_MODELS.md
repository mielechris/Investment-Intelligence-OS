# T124 — Implement domain intelligence read models
...
**Dependencies:** T113,T114,T117,T119,T120,T121  
...
Create queryable current-state projections for sector, weather/agriculture, commodities, geopolitics, corporate links, and flows.
...
- [ ] Commit references `T124`.

## Suggested Commit

`feat(domain_intelligence): implement domain intelligence read models [T124]`
