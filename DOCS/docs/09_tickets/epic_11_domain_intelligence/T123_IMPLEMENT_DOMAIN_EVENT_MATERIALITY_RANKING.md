# T123 — Implement domain event materiality ranking

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-022,SPEC-024,SPEC-025,SPEC-026  
**Dependencies:** T114,T117,T119,T120  
...
Rank domain events by novelty, severity, exposure, source quality, and portfolio relevance without turning ranking into a trade.

## Why This Matters

Adds the policy, physical, corporate, geopolitical, weather, commodity, and flow context central to IIOS.
...
- [ ] Ranking dimensions visible
- [ ] Critical exposure boosts review priority
- [ ] No automatic order path

## Required Tests

- High portfolio exposure event
- Low relevance event
...
- [ ] Commit references `T123`.

## Suggested Commit

`feat(domain_intelligence): implement domain event materiality ranking [T123]`
