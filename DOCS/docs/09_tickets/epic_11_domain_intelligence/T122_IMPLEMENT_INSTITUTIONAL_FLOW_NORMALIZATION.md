# T122 — Implement institutional flow normalization

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-028  
**Dependencies:** T044,T048,T055  
...
Normalize delayed public holdings, insider, positioning, or flow disclosures with measurement and publication lag.
...
- [ ] Measurement time separate from availability
- [ ] Unknown hedge flag supported
- [ ] Historical test uses availability
...
- [ ] Commit references `T122`.

## Suggested Commit

`feat(domain_intelligence): implement institutional flow normalization [T122]`
