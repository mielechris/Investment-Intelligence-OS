# T114 — Implement sector state builder

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-022  
**Dependencies:** T028,T055,T113  
...
Build point-in-time sector constituents, relative performance, breadth, rate sensitivity, policy and commodity exposures.
...
- [ ] Benchmark specified
- [ ] Evidence links for exposures

## Required Tests

- Sector constituent history
...
- [ ] Commit references `T114`.

## Suggested Commit

`feat(domain_intelligence): implement sector state builder [T114]`
