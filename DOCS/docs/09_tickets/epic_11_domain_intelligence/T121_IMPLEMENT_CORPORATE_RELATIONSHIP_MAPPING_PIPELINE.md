# T121 — Implement corporate relationship mapping pipeline

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-027  
**Dependencies:** T028,T064  
...
Build evidence-backed company links to suppliers, customers, facilities, technologies, contracts, and geographies.
...
- [ ] Direct filing relationship higher confidence
- [ ] Validity interval
...
- [ ] Commit references `T121`.

## Suggested Commit

`feat(domain_intelligence): implement corporate relationship mapping pipeline [T121]`
