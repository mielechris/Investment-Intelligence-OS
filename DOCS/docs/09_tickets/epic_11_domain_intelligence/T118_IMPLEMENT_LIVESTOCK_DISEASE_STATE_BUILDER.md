# T118 — Implement livestock disease state builder
...
Represent public disease, herd, feed-cost, slaughter, and trade-restriction context.
...
- [ ] Disease evidence linked
- [ ] Geography/species explicit
- [ ] Trade restrictions versioned
...
- [ ] Commit references `T118`.

## Suggested Commit

`feat(domain_intelligence): implement livestock disease state builder [T118]`
