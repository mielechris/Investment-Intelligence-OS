# T116 — Implement weather observation adapter and normalizer

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-024  
...
Normalize approved weather observations by geography, time, variable, unit, and anomaly.
...
- [ ] Commit references `T116`.

## Suggested Commit

`feat(domain_intelligence): implement weather observation adapter and normalizer [T116]`
