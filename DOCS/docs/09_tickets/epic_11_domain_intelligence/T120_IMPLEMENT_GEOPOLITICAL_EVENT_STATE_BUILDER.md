# T120 — Implement geopolitical event state builder

**Epic:** E11 — Domain Intelligence  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-025  
**Dependencies:** T054,T028  
...
Represent conflict, sanctions, trade, diplomacy, routes, escalation/de-escalation branches.
...
- [ ] Actors/geography/evidence required
- [ ] Scenario branches supported
- [ ] Unverified rumor confidence low
...
- [ ] Commit references `T120`.

## Suggested Commit

`feat(domain_intelligence): implement geopolitical event state builder [T120]`
