# T136 — Implement application health aggregation

**Epic:** E13 — Observability Operations and Recovery  
**Priority:** P0  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-015,SPEC-018  
**Dependencies:** T050,T135,T093,T099  
...
Aggregate DB, object store, source, market data, worker, scheduler, model, risk, accounting, and backup health.
...
- [ ] Critical unhealthy component can force STAND_DOWN
- [ ] Health dimensions visible individually

## Required Tests

- Critical risk outage
- Noncritical source degraded
...
- [ ] Commit references `T136`.

## Suggested Commit

`feat(operations): implement application health aggregation [T136]`
