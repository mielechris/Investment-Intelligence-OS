# T140 — Implement isolated restore command
...
Restore a backup into isolated test environment and verify authoritative state.
...
- [ ] DB and object references restored
- [ ] Environment remains TEST
- [ ] Golden trace data queryable
...
- [ ] Commit references `T140`.

## Suggested Commit

`feat(operations): implement isolated restore command [T140]`
