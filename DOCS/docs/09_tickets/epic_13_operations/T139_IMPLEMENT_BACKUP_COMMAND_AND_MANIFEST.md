# T139 — Implement backup command and manifest
...
Create version-aware backup of PostgreSQL and object-store state with manifest.
...
- [ ] Backup records schema/release version
- [ ] Artifact integrity hash
- [ ] Failure nonzero/visible
...
- [ ] Commit references `T139`.

## Suggested Commit

`feat(operations): implement backup command and manifest [T139]`
