# T137 — Implement core metrics instrumentation
...
Measure ingestion, workflows, model usage, decisions, risk, portfolio, and research operations.
...
- [ ] Commit references `T137`.

## Suggested Commit

`feat(operations): implement core metrics instrumentation [T137]`
