# T162 — Create strategy reverse-engineering review template and scorecard
...
Standardize accept/revise/reject decisions for public strategy research.
...
- [ ] Unknowns mandatory
- [ ] Out-of-sample evidence required
- [ ] Copy-trade limitations visible
...
- [ ] Commit references `T162`.

## Suggested Commit

`feat(strategy_research): create strategy reverse-engineering review template and scorecard [T162]`
