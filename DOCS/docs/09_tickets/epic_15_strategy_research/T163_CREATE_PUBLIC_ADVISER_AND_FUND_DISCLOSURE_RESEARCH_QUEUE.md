# T163 — Create public-adviser and fund disclosure research queue
...
Maintain a governed queue of public managers, advisers, and funds worth researching based on observable disclosures rather than reputation alone.
...
- [ ] Queue records source type and lag
- [ ] Selection criteria documented
- [ ] No manager labeled best without evidence
...
- [ ] Commit references `T163`.

## Suggested Commit

`feat(strategy_research): create public-adviser and fund disclosure research queue [T163]`
