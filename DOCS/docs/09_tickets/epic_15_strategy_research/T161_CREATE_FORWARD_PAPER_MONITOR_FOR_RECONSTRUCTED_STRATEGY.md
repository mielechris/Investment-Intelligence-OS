# T161 — Create forward paper monitor for reconstructed strategy
...
Generate separate paper observations for a validated reconstructed strategy.
...
- [ ] Separate strategy version/portfolio or sleeve
- [ ] Risk still enforced
- [ ] Forward signals frozen/versioned

## Required Tests

- Forward signal fixture
...
- [ ] Commit references `T161`.

## Suggested Commit

`feat(strategy_research): create forward paper monitor for reconstructed strategy [T161]`
