# T158 — Create reconstructed-strategy rule builder

**Epic:** E15 — Strategy Research and Reverse Engineering  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-008,SPEC-017  
**Dependencies:** T157,T071  
...
Translate one candidate family into explicit testable entry, exit, sizing proposal, and universe rules.
...
- [ ] Rules versioned
- [ ] Unknown behavior represented
- [ ] No hidden assumptions omitted
...
- [ ] Commit references `T158`.

## Suggested Commit

`feat(strategy_research): create reconstructed-strategy rule builder [T158]`
