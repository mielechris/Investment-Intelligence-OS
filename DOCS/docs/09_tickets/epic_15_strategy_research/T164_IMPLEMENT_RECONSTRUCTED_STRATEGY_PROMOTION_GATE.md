# T164 — Implement reconstructed-strategy promotion gate

**Epic:** E15 — Strategy Research and Reverse Engineering  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-008,SPEC-030  
**Dependencies:** T159,T160,T161,T162  
...
Require point-in-time, holdout, cost, robustness, and forward-paper evidence before a reconstructed strategy can be promoted.
...
- [ ] All research gates checked
- [ ] Missing gate blocks promotion
- [ ] Decision recorded

## Required Tests

- Promotion rejection
- Promotion pass fixture
...
- [ ] Commit references `T164`.

## Suggested Commit

`feat(strategy_research): implement reconstructed-strategy promotion gate [T164]`
