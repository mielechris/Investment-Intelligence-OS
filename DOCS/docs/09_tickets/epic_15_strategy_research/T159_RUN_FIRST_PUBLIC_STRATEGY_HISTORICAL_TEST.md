# T159 — Run first public strategy historical test
...
Test one reconstructed public strategy with point-in-time data and baseline.
...
- [ ] Commit references `T159`.

## Suggested Commit

`feat(strategy_research): run first public strategy historical test [T159]`
