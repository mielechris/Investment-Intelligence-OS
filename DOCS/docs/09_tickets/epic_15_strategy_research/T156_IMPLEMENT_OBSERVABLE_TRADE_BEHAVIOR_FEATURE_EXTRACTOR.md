# T156 — Implement observable-trade behavior feature extractor

**Epic:** E15 — Strategy Research and Reverse Engineering  
**Priority:** P1  
**Status:** BACKLOG  
**Estimate:** 2-6h  
**Specifications:** SPEC-008,SPEC-028  
**Dependencies:** T155,T122,T055  
...
Derive time-safe features from disclosed positions, entries, exits, holding periods, sectors, and market context.
...
- [ ] Uses publication availability
- [ ] Missing hidden positions explicitly unknown
- [ ] Feature versioned

## Required Tests

- Delayed filing feature
...
- [ ] Commit references `T156`.

## Suggested Commit

`feat(strategy_research): implement observable-trade behavior feature extractor [T156]`
