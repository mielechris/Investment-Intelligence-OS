...
Represent macro and market conditions probabilistically for regime-aware reasoning and testing.
...
- [ ] Outputs include probabilities and supporting/contradictory indicators.
- [ ] Historical labels use only historical information.
- [ ] Transitions represented.
- [ ] Strategy performance can segment by regime.

## 10. Required Tests

- Verify: Outputs include probabilities and supporting/contradictory indicators.
- Verify: Historical labels use only historical information.
- Verify: Transitions represented.
- Verify: Strategy performance can segment by regime.
