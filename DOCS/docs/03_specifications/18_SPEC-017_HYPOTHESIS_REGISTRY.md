...
Turn ideas into explicit falsifiable research objects before strategies or trades.
...
2. Assets and direction.
3. Horizon and expected lag.
4. Causal/counter-chain.
5. Assumptions.
6. Falsifiers.
7. Required data.
8. Benchmark.
9. Success/failure metrics.
10. Versioned lifecycle.
...
- [ ] Counter-chain and benchmark exist.
- [ ] Invalid promotion rejected.
- [ ] Material revision creates new version.
- [ ] Retirement preserves history.

## 10. Required Tests

- Verify: Hypothesis is falsifiable.
- Verify: Counter-chain and benchmark exist.
- Verify: Invalid promotion rejected.
- Verify: Material revision creates new version.
- Verify: Retirement preserves history.
