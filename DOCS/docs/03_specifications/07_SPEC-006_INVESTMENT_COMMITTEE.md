...
Aggregate specialist views into candidate, watch, avoid, or no-trade decisions while preserving dissent.
...
1. Required-agent composition.
2. Skeptic participation.
3. Bounded debate.
4. Missing-evidence requests.
5. Dissent records.
6. Decision expiration.
7. Structured rationale.
8. No-trade path.
9. No direct execution authority.
...
- [ ] Missing required view blocks or downgrades decision.
- [ ] Dissent preserved.
- [ ] Debate stops at budget.
- [ ] No-trade supported.
- [ ] Committee cannot create order.

## 10. Required Tests

- Verify: Missing required view blocks or downgrades decision.
- Verify: Dissent preserved.
- Verify: Debate stops at budget.
- Verify: No-trade supported.
- Verify: Committee cannot create order.
