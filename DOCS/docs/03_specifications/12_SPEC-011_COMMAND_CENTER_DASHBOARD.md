# SPEC-011 — Command Center Dashboard
...
Provide a ten-minute operational view of world state, evidence, opportunities, risk, paper portfolio, learning, and system health.
...
- `Rendered command-center views`
- `User action requests through API`
...
- [ ] Paper mode always visible.
- [ ] Stale state explicit.
- [ ] Decision links to source evidence.
- [ ] Risk veto/no-trade clear.
- [ ] Browser cannot alter authoritative calculations.

## 10. Required Tests

- Verify: Paper mode always visible.
- Verify: Stale state explicit.
- Verify: Decision links to source evidence.
- Verify: Risk veto/no-trade clear.
- Verify: Browser cannot alter authoritative calculations.
