# SPEC-022 — Sector Intelligence

**Priority:** P1  
**Owner:** Corporate / Market Intelligence  
...
Track sector composition, fundamentals, macro sensitivity, policy exposure, commodity exposure, valuation, breadth, and rotation.
...
1. Point-in-time constituents.
2. Policy exposure.
3. Rate sensitivity.
4. Commodity dependencies.
5. Revenue geography.
6. Valuation.
...
- [ ] Constituents point-in-time.
- [ ] Policy exposure evidence-linked.
- [ ] Relative performance benchmarked.
- [ ] Sector state feeds thesis and risk clustering.

## 10. Required Tests

- Verify: Constituents point-in-time.
- Verify: Policy exposure evidence-linked.
- Verify: Relative performance benchmarked.
- Verify: Sector state feeds thesis and risk clustering.
