# SPEC-014 — AI Governance and Model Registry
...
Control approved models and prompts and evaluate their reliability, cost, latency, and drift.
...
1. Model registry.
2. Prompt registry.
3. Agent-model permissions.
4. Evaluation gates.
5. Fallback policy.
6. Cost/latency telemetry.
7. Drift monitoring.
8. Retirement.
9. Historical model lineage.
...
- [ ] Unapproved model cannot run paper workflow.
- [ ] Prompt change versioned.
- [ ] Fallback recorded.
- [ ] Regression suite gates promotion.
- [ ] Retired model remains in historical lineage.

## 10. Required Tests

- Verify: Unapproved model cannot run paper workflow.
- Verify: Prompt change versioned.
- Verify: Fallback recorded.
- Verify: Regression suite gates promotion.
- Verify: Retired model remains in historical lineage.
