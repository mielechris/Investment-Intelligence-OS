# SPEC-028 — Institutional Flow Tracker

**Priority:** P1  
**Owner:** Flow / Market Intelligence  
...
Track public holdings, insider transactions, futures positioning, fund flows, and other approved disclosures with lag-aware interpretation.
...
1. Public institutional holdings.
2. Insider filings.
3. Futures positioning.
4. Fund/ETF flows.
5. Short interest where approved.
6. Buybacks.
7. Reporting lag.
8. Hedge uncertainty.
9. Derived flow features.
...
- [ ] Reported and current position distinguished.
- [ ] Unknown hedges visible.
- [ ] Historical tests use publication availability.
- [ ] Flow feature source-linked.

## 10. Required Tests

- Verify: Publication lag explicit.
- Verify: Reported and current position distinguished.
- Verify: Unknown hedges visible.
- Verify: Historical tests use publication availability.
- Verify: Flow feature source-linked.
