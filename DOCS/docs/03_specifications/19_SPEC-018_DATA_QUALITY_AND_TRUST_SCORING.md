# SPEC-018 — Data Quality and Trust Scoring
...
Score provenance, freshness, validity, consistency, revision risk, extraction confidence, independence, and rights without hiding dimensions.
...
1. Separate trust and quality dimensions.
2. Source-specific freshness.
3. Directness.
4. Completeness.
5. Schema validity.
6. Revision risk.
...
- [ ] Secondary repetition not treated as independent.
- [ ] Critical stale source affects risk.
- [ ] Rights uncertainty quarantines.
- [ ] Score explanation visible.

## 10. Required Tests

- Verify: Trust and quality remain separate.
- Verify: Secondary repetition not treated as independent.
- Verify: Critical stale source affects risk.
- Verify: Rights uncertainty quarantines.
- Verify: Score explanation visible.
