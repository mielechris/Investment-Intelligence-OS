...
Stress-test theses and portfolios across economic, policy, geopolitical, weather, commodity, market, and operational scenarios.
...
1. Historical replay.
2. Deterministic shocks.
3. Policy branches.
4. Rates/inflation shocks.
5. War/sanctions.
6. Weather/agriculture shocks.
7. Commodity shocks.
8. Correlation/liquidity shocks.
...
- [ ] Operational portfolio not mutated.
- [ ] Risk breaches reported.
- [ ] Historical replay point-in-time correct.

## 10. Required Tests

- Verify: Scenario reproducible.
- Verify: Assumptions explicit.
- Verify: Operational portfolio not mutated.
- Verify: Risk breaches reported.
- Verify: Historical replay point-in-time correct.
