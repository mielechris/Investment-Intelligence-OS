...
Simulate realistic execution and portfolio accounting without live capital.
...
1. Paper-only backend enforcement.
2. Order lifecycle.
3. Risk preconditions.
4. Idempotent order intents.
5. Spread/slippage/fees.
6. Partial fills.
7. Atomic accounting.
8. Reconciliation.
9. Kill switch.
10. Instrument capability checks.
...
- [ ] No order without active risk approval.
- [ ] Duplicate intent creates one order.
- [ ] Duplicate fill not applied twice.
- [ ] Cash and positions reconcile.
- [ ] Live adapter unavailable.

## 10. Required Tests

- Verify: No order without active risk approval.
- Verify: Duplicate intent creates one order.
- Verify: Duplicate fill not applied twice.
- Verify: Cash and positions reconcile.
- Verify: Live adapter unavailable.
