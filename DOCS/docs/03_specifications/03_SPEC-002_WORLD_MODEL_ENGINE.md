...
Maintain a versioned, point-in-time representation of the economic, policy, corporate, commodity, geopolitical, weather, and market environment.
...
1. Canonical entities and aliases.
2. Versioned relationships.
3. Immutable world-state snapshots.
4. Policy lifecycle.
5. Regime state.
6. Stale-domain indicators.
7. Materiality detection.
8. Historical as-known-at queries.
9. Entity merge/split lineage.
10. Portfolio causal exposure.
...
- [ ] Historical snapshot excludes later information.
- [ ] Meeting and formal implementation remain distinct.
- [ ] Entity merge preserves history.
- [ ] Stale domain visible.
- [ ] Material update triggers reevaluation.

## 10. Required Tests

- Verify: Historical snapshot excludes later information.
- Verify: Meeting and formal implementation remain distinct.
- Verify: Entity merge preserves history.
- Verify: Stale domain visible.
- Verify: Material update triggers reevaluation.
