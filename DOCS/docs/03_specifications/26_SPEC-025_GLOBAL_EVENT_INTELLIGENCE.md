# SPEC-025 — Global Event Intelligence

**Priority:** P1  
**Owner:** Geopolitical Intelligence  
...
Represent war, sanctions, trade, diplomacy, elections, shipping, and neighboring-country policy with scenario-aware economic transmission.
...
6. Trade deals.
7. Shipping disruptions.
8. Government transitions.
9. Currency controls.
10. Scenario branches.
...
- [ ] Event has geography and evidence.
- [ ] Escalation not treated as certain.
- [ ] High-impact events have branches.
- [ ] Trade/commodity links traceable.
- [ ] Market reaction benchmarked.

## 10. Required Tests

- Verify: Event has geography and evidence.
- Verify: Escalation not treated as certain.
- Verify: High-impact events have branches.
- Verify: Trade/commodity links traceable.
- Verify: Market reaction benchmarked.
