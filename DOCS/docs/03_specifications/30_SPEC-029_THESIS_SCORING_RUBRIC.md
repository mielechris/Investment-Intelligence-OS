# SPEC-029 — Thesis Scoring Rubric

**Priority:** P0/P1  
**Owner:** Decision / Research  
...
Standardize thesis comparison with decomposed dimensions and hard gates rather than one opaque magic score.
...
1. Source quality.
2. Evidence directness.
3. Independent corroboration.
4. Causal coherence.
5. Implementation probability.
6. Counter-case strength.
7. Historical support.
8. Regime fit.
9. Market confirmation.
10. Pricing.
11. Timing.
12. Liquidity.
13. Crowding.
...
- [ ] Composite is decomposable.
- [ ] Hard gate overrides ranking.
- [ ] Missing values explicit.
- [ ] Score cannot bypass risk.
- [ ] Calibration measurable.

## 10. Required Tests

- Verify: Composite is decomposable.
- Verify: Hard gate overrides ranking.
- Verify: Missing values explicit.
- Verify: Score cannot bypass risk.
- Verify: Calibration measurable.
