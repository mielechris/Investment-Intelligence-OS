# SPEC-004 — Causal Chain Engine

**Priority:** P0  
**Owner:** Reasoning Platform  
...
Build testable cause-to-effect mechanisms with counter-chains, expected lags, assumptions, and falsifiers.
...
1. Ordered causal steps.
2. Mechanism per step.
3. Expected sign and lag.
4. Evidence versus assumption distinction.
5. Counter-chain.
6. Missing-information detection.
7. Historical analog integration.
8. Falsifiers.
...
- [ ] Each material step has evidence or explicit assumption.
- [ ] Expected lag and falsifier required.
- [ ] Counter-chain required for promoted thesis.
- [ ] Analog shows differences.
- [ ] Source revision triggers reevaluation.

## 10. Required Tests

- Verify: Each material step has evidence or explicit assumption.
- Verify: Expected lag and falsifier required.
- Verify: Counter-chain required for promoted thesis.
- Verify: Analog shows differences.
- Verify: Source revision triggers reevaluation.
