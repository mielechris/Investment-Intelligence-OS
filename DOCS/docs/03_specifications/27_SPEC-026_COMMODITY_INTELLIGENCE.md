# SPEC-026 — Commodity Intelligence

**Priority:** P1  
**Owner:** Commodity Intelligence  
...
Maintain supply, demand, inventory, logistics, seasonality, weather, geopolitics, substitution, and futures-curve context.
...
- [ ] Supply/demand data timestamped.
- [ ] Spot and futures distinguished.
- [ ] Seasonality considered.
- [ ] Weather/geopolitical links explicit.
- [ ] Livestock disease can propagate through causal chain.

## 10. Required Tests

- Verify: Supply/demand data timestamped.
- Verify: Spot and futures distinguished.
- Verify: Seasonality considered.
- Verify: Weather/geopolitical links explicit.
- Verify: Livestock disease can propagate through causal chain.
