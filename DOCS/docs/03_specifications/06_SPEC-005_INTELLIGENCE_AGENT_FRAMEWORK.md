# SPEC-005 — Intelligence Agent Framework
...
Run bounded specialist AI analysts with approved tools, governed retrieval, structured outputs, and auditable versions.
...
2. Model gateway.
3. Tool allow-lists.
4. Time-cutoff retrieval.
5. Structured output validation.
6. Abstention.
7. Cost and step limits.
8. Prompt injection defense.
9. Model/prompt lineage.
10. Immutable completed outputs.
...
- [ ] Agent cannot place order or change risk.
- [ ] Unsupported citation fails.
...
- Verify: Agent cannot place order or change risk.
- Verify: Unsupported citation fails.
- Verify: Prompt injection cannot escalate authority.
- Verify: Abstention works.
- Verify: Model and prompt versions recorded.
