# SPEC-007 — Portfolio Construction and Risk Engine
...
Evaluate portfolio suitability and enforce deterministic risk limits with veto authority.
...
1. Position caps.
2. Theme and causal-cluster caps.
3. Sector and asset-class limits.
...
- [ ] Veto blocks order.
- [ ] High confidence cannot bypass limits.
- [ ] Theme clustering prevents false diversification.
- [ ] Stale critical data blocks new risk.
- [ ] Risk decision versioned and auditable.

## 10. Required Tests

- Verify: Veto blocks order.
- Verify: High confidence cannot bypass limits.
- Verify: Theme clustering prevents false diversification.
- Verify: Stale critical data blocks new risk.
- Verify: Risk decision versioned and auditable.
