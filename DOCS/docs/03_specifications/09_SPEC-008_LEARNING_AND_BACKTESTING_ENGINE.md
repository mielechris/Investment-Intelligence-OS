# SPEC-008 — Learning and Backtesting Engine
...
Test hypotheses with point-in-time data, baselines, holdouts, realistic costs, regime analysis, and forward paper learning.
...
5. Benchmarks.
6. Backtests.
7. Walk-forward and holdout.
8. Cost/slippage models.
9. Parameter sensitivity.
10. Promotion and retirement.
...
- [ ] Future revisions excluded.
- [ ] Benchmark mandatory.
- [ ] Gross and net results shown.
- [ ] Holdout separated.
- [ ] Failed research preserved.
- [ ] Promotion requires evidence gates.

## 10. Required Tests

- Verify: Future revisions excluded.
- Verify: Benchmark mandatory.
- Verify: Gross and net results shown.
- Verify: Holdout separated.
- Verify: Failed research preserved.
- Verify: Promotion requires evidence gates.
