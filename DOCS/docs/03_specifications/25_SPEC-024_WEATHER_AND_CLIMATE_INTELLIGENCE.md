# SPEC-024 — Weather and Climate Intelligence

**Priority:** P1  
**Owner:** Environmental / Commodity  
...
Translate weather observations and climate context into evidence-backed economic exposure.
...
2. Temperature.
3. Drought.
4. Storm/flood/freeze/heat.
5. Geography.
6. Crop calendar.
7. Seasonal anomaly.
8. Energy demand.
9. Infrastructure exposure.
10. Weather-vs-climate distinction.
...
- [ ] Geography and crop stage considered.
- [ ] Weather event alone cannot create trade.
- [ ] Transmission chain required.
- [ ] Stale weather feed visible.
- [ ] Timescale matches investment horizon.

## 10. Required Tests

- Verify: Geography and crop stage considered.
- Verify: Weather event alone cannot create trade.
- Verify: Transmission chain required.
- Verify: Stale weather feed visible.
- Verify: Timescale matches investment horizon.
