...
The observation identity is `financial-datasets-pricing-2026-09-08-v1`, observed from the public official pricing page at `2026-09-08T01:25:49Z` and expiring at `2026-09-09T01:25:49Z`. The interval is exactly 24 hours and covers the September 8 close plus the bounded 13:05 PDT locking margin. Operational material binds this identity, the official pricing URL and those UTC boundaries. A changed identity, ambiguity or expired observation fails closed; browser polling and provider execution cannot refresh it. Refresh requires the reviewed non-spending administrative command.
