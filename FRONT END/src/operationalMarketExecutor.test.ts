...
test("operational execution projection is count-only and read-only", () => {
  for (const label of ["Installation", "Planned", "Dispatched", "Completed", "Remaining", "Adopted canary", "Failed", "Ambiguous", "Evidence receipts", "Confirmed credits", "Released credits", "Credential accesses", "Stage A", "Stage B", "Stage C"])
