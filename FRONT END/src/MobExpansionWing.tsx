  ...
  return <div className="mew-grid mew-tuesday-grid">
    <Panel id="tuesday-command" eyebrow="OPENING-DAY CONTROL" title="Tuesday Test Day Command Center" state="NOT_ACTIVATED" className="mew-wide">
      <section className="mew-whole-factory-plan" aria-labelledby="mew-whole-factory-title">
        ...
        <dl><div><dt>Future daily ceiling</dt><dd>200</dd></div><div><dt>Released now</dt><dd>0</dd></div><div><dt>Automatic release</dt><dd>Prohibited</dd></div><div><dt>Browser invocation</dt><dd>Prohibited</dd></div></dl>
