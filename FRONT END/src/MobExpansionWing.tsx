...
function TuesdayCommandCenter({ snapshot }: { snapshot: ExpansionSnapshot | null }) {
  ...
  return <div className="mew-grid mew-tuesday-grid">
    <Panel id="tuesday-command" eyebrow="OPENING-DAY CONTROL" title="Tuesday Test Day Command Center" state="NOT_ACTIVATED" className="mew-wide">
      <section className="mew-tuesday-hero" aria-labelledby="mew-tuesday-hero-title"><span>TUESDAY PAPER TEST</span><h2 id="mew-tuesday-hero-title">10 pilots · 3 observations each · 30-credit maximum</h2><strong>Controller disabled — awaiting authorization</strong><div className="mew-observation-phases"><article><b>1</b><span>Opening Evidence</span><small>Not scheduled until authorization</small></article><article><b>2</b><span>Intraday Mark</span><small>One bounded observation</small></article><article><b>3</b><span>Closing Mark</span><small>Reconcile without promotion</small></article></div><dl><div><dt>Next allowable action</dt><dd>Authorize the governed Tuesday controller</dd></div><div><dt>Market / session</dt><dd>{scalar(market.state)}</dd></div><div><dt>Current evidence</dt><dd>Waiting for Tuesday</dd></div><div><dt>Provider requests today</dt><dd>0</dd></div><div><dt>Credits used / maximum</dt><dd>0 / 30</dd></div><div><dt>Browser invocation</dt><dd>Prohibited</dd></div><div><dt>Operational trading</dt><dd>Disabled</dd></div></dl><details><summary>Exact contract details</summary><p>WAITING_FOR_CURRENT_TUESDAY_EVIDENCE · FORWARD_ONLY_UNADJUSTED_OBSERVATION · CONTROLLER_DISABLED · AUTOMATIC_RETRY_PROHIBITED</p></details></section>
