  ...
  return <div className="mew-grid mew-tuesday-grid" data-controller-version={controllerV2 ? "v2" : "v1"}>
    <Panel id="tuesday-command" eyebrow="OPENING-DAY CONTROL" title="Tuesday Test Day Command Center" state="NOT_ACTIVATED" className="mew-wide">
      ...
      <section className="mew-provider-readiness" aria-label="Stage A provider readiness">
        ...
        <MetricGrid values={[["Commissioning", providerReadiness.commissioning_state], ["Unattended supervisor", providerReadiness.unattended_service_state], ["One-day policy", providerReadiness.one_day_policy_state], ["Provider", providerReadiness.provider_identity], ["Cost contract", providerReadiness.cost_contract_state], ["Request plan identities", providerReadiness.planned_identity_count], ["Request plan", providerReadiness.request_plan_state], ["Supported and costed", providerReadiness.supported_costed_identity_count], ["Blocked identities", providerReadiness.unsupported_identity_count], ["Expected Stage A cost", providerReadiness.worst_case_stage_a_credits], ["Stage A maximum", providerReadiness.stage_a_maximum], ["Daily hard ceiling", providerReadiness.daily_hard_ceiling], ["Credential", providerReadiness.credential_presence_state], ["Released credits", providerReadiness.stage_a_released_credits], ["Stage B / C", `${text(providerReadiness.stage_b_state)} / ${text(providerReadiness.stage_c_state)}`], ["Failure category", providerReadiness.failure_category], ["Trading authority", false]]} />
