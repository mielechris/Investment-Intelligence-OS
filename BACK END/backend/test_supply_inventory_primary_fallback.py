...
class SupplyInventoryPrimaryFallbackTests(unittest.TestCase):
    ...
    def test_snapshots_cover_five_operational_facts_with_wafer_starts_open(self):
    ...
    def test_five_of_six_remains_partial_even_with_all_suppliers_covered(self):
        items = [
            {
        ...
        self.assertEqual(coverage["missing_fact_keys"], ["wafer_starts"])
    ...
    def test_all_six_operational_facts_are_required_for_resolution(self):
        items = [
            {
                "primary_fact_key": row["fact_key"],
                "claim": row["claim"],
        ...
        items.append(
            {
                "primary_fact_key": "wafer_starts",
                "claim": "Verified quantified DRAM wafer-start measurement",
