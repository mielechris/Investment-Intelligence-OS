...
def run_parallel_high_speed_cycle(
    *,
    ...
    reuse = core._can_reuse_deep_context(fingerprint)
    ...
    if reuse:
        grok, kimi = core._reuse_model_context()
    else:
    ...
    state = {
        ...
        "deep_research_completed_at": (
            completed_at if not reuse else prior_state.get("deep_research_completed_at")
        ),
        "deep_fingerprint": fingerprint,
